"""UNet with a heteroscedastic (mu, log-scale) output head.
...
mean ``mu`` (same role as the existing model's output) and a second
channel (named/clipped as ``log_var`` for historical reasons — see
